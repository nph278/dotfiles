...
(custom-theme-set-faces
 ...
 ;; ansi
 `(ansi-color-green                              ((t (:foreground ,(d 'green)))))
 ...
 `(ansi-color-yellow                             ((t (:foreground ,(d 'yellow)))))
 `(ansi-color-bright-white                       ((t (:foreground ,(d 'bright-white)))))

 ;; term
 `(term-color-blue                               ((t (:background ,(d 'blue) :foreground ,(d 'blue)))))
 `(term-color-bright-blue                        ((t (:inherit 'term-color-blue))))
 `(term-color-green                              ((t (:background ,(d 'green) :foreground ,(d 'green)))))
 `(term-color-bright-green                       ((t (:inherit 'term-color-green))))
 `(term-color-black                              ((t (:background ,(d 'black) :foreground ,(d 'black)))))
 `(term-color-bright-black                       ((t (:inherit 'term-color-black))))
 `(term-color-white                              ((t (:background ,(d 'white) :foreground ,(d 'white)))))
 `(term-color-bright-white                       ((t (:inherit 'term-color-white))))
 `(term-color-red                                ((t (:background ,(d 'red) :foreground ,(d 'red)))))
 `(term-color-bright-red                         ((t (:inherit 'term-color-red))))
 `(term-color-yellow                             ((t (:background ,(d 'yellow) :foreground ,(d 'yellow)))))
 `(term-color-bright-yellow                      ((t (:inherit 'term-color-yellow))))
 `(term-color-cyan                               ((t (:background ,(d 'cyan) :foreground ,(d 'cyan)))))
 `(term-color-bright-cyan                        ((t (:inherit 'term-color-cyan))))
 `(term-color-magenta                            ((t (:background ,(d 'magenta) :foreground ,(d 'magenta)))))
