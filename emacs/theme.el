...
(custom-theme-set-faces
 ...
 `(button                                        ((t (:foreground ,(d 'soft-accent)))))
 ...
 `(match                                         ((t (:background ,(d 'warning) :foreground ,(d 'light-fg)))))
 ...
 `(region                                        ((t (:background ,(d 'soft-accent)))))
 `(success                                       ((t (:foreground ,(d 'success)))))
 `(vertical-border                               ((t (:foreground ,(d 'dark-bg-2)))))
 `(warning                                       ((t (:foreground ,(d 'warning)))))
 ...
 `(font-lock-warning-face                        ((t (:foreground ,(d 'warning)))))
 ...
 `(minibuffer-prompt-end                         ((t (:foreground ,(d 'error) :background ,(d 'soft-error)))))
 `(minibuffer-prompt                             ((t (:foreground ,(d 'warning) :background ,(d 'soft-warning)))))
 `(epa-mark                                      ((t (:foreground ,(d 'error)))))
 `(dired-mark                                    ((t (:foreground ,(d 'error)))))
 ...
 `(org-meta-line                                 ((t (:background ,(d 'soft-success) :foreground ,(d 'success)))))
 `(org-headline-done                             ((t (:foreground ,(d 'finished) :strike-through t))))
 `(org-todo                                      ((t (:foreground ,(d 'warning) :bold t))))
 `(org-headline-todo                             ((t (:foreground ,(d 'warning)))))
 `(org-upcoming-deadline                         ((t (:foreground ,(d 'error)))))
 ...
 `(show-paren-mismatch                           ((t (:background ,(d 'error) :foreground ,(d 'light-fg)))))
 `(tooltip                                       ((t (:foreground ,(d 'light-fg) :background ,(d 'warning) :bold t))))
 ...
 `(git-gutter:added                              ((t (:foreground ,(d 'success)))))
 `(git-gutter:deleted                            ((t (:foreground ,(d 'error)))))
 `(git-gutter:modified                           ((t (:foreground ,(d 'warning)))))

 `(diff-hl-margin-change                         ((t (:foreground ,(d 'success) :background ,(d 'light-success)))))
 `(diff-hl-margin-delete                         ((t (:foreground ,(d 'error) :background ,(d 'light-error)))))
 `(diff-hl-margin-insert                         ((t (:foreground ,(d 'warning) :background ,(d 'light-warning)))))

 `(bm-fringe-face                                ((t (:background ,(d 'error) :foreground ,(d 'light-fg)))))
 `(bm-fringe-persistent-face                     ((t (:background ,(d 'error) :foreground ,(d 'light-fg)))))
