...
(define sway-options
  `(("floating_modifier" ,sway-mod "normal")
    ...
    ;; Client
    ("client.focused" ,(d 'accent) ,(d 'accent) ,(d 'light-fg) ,(d 'success) ,(d 'accent))
    ("client.focused_inactive" ,(d 'dark-bg) ,(d 'dark-bg) ,(d 'dark-fg) ,(d 'success) ,(d 'dark-bg))
    ("client.unfocused" ,(d 'dark-bg) ,(d 'dark-bg) ,(d 'dark-fg) ,(d 'success) ,(d 'dark-bg))
    ("client.urgent" ,(d 'error) ,(d 'error) ,(d 'light-fg) ,(d 'success) ,(d 'error))
    ...
    ("bar colors urgent_workspace" ,(d 'error) ,(d 'error) ,(d 'light-fg))))
...
(define qutebrowser-options
  `(("url.default_page" . "about:blank")
    ...
    ("colors.contextmenu.disabled.fg" . ,(d 'error))
    ...
    ("colors.messages.warning.bg" . ,(d 'warning))
    ("colors.messages.warning.border" . ,(d 'warning))
